...
public class Controller {
    ...
    private void connectAndSend(int value) {
        try {
    ...
    private void sendScore(int pokemonsDefeated) {
        try {
            DataOutputStream dos = new DataOutputStream(client.getOutputStream());

            dos.writeUTF(String.valueOf(pokemonsDefeated));
